...
#python -m tools.run_one_node4plugin --data_dir data/phone_v0 --runs_dir runs/one_node --run_meta configs/phone_sellout_demo.json --index_path runs/one_node/_index.jsonl
